...
- 2026-06-28 23:xx - Deployed to GitHub Pages (repo legtar/fp-boost-pkm-landing): https://legtar.github.io/fp-boost-pkm-landing/.
- 2026-06-29 - Max SEO pass: canonical, OG/Twitter, geo tags, JSON-LD graph (Org/WebSite/WebPage/Service/FAQPage/HowTo), robots.txt, sitemap.xml, 404.html, manifest. Lighthouse 100/100/100.
- 2026-06-29 - Imagery: extracted 267 embedded images from source PDF (tools/extract_images.py, process_images.py); replaced slide screenshots with real montage/object photos + hi-res cert scans. Generated 4 AI images via OpenAI gpt-image-1 (hero, OG cover, macro-seal backdrop, materials studio shot) using real photos as references (~$0.77 total). Custom SVG advantage icons + EIT fire-resistance diagram.
- 2026-06-29 - Competitor SEO analysis (ogneza/tehstrong/germoizol/firelines.dkc/promrukav/dkc) + Yandex multi-site strategy deep-research (verdict: affiliate filter kills single-company site networks; build one strong site instead).
- 2026-06-29 - Built static site generator tools/build_site.py. P1: 4 product-type pages + interactive node-selection calculator (calc.js). P2: knowledge hub /stati/ with 8 technical articles, /glossariy/, /normativy/. P3: /obekty/ (cases) + /dostavka/. Now 19 indexable URLs, each with breadcrumbs + Product/Article/FAQ/HowTo schema. server.mjs now serves directory index.html. Lighthouse on inner pages 100/100/100.
